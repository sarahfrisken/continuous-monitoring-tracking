...
class CM_Tracking(ScriptedLoadableModule):
...
# CM_TrackingWidget
#
class CM_TrackingWidget(ScriptedLoadableModuleWidget):
...
# CM_TrackingLogic
#
class CM_TrackingLogic(ScriptedLoadableModuleLogic):
...
class CM_TrackingTest(ScriptedLoadableModuleTest):
  """
